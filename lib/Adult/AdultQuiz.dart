...
import 'package:vidhipedia/Adult/AdultQuizPage1.dart';
import 'package:vidhipedia/Adult/AdultLeaderboard.dart';
import 'package:vidhipedia/Adult/Adultforum.dart';
class AdultQuiz extends StatefulWidget {
  @override
  State<AdultQuiz> createState() => AdultQuizScreen();
}

class AdultQuizScreen extends State<AdultQuiz> with SingleTickerProviderStateMixin {
  bool bigCont = true;
  bool cont = false;
                          ...
                          child: Column(
                            children: [
                              ...
                              TextButton(
                                onPressed: () {
                                  if (index == 0) {
                                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => KidsQuizPage1()));
