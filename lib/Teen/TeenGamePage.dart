...
class Gamepage extends StatefulWidget {
  @override
  State<Gamepage> createState() => GameScreen();
}

class GameScreen extends State<Gamepage> with SingleTickerProviderStateMixin {
  bool bigCont = true;
  bool cont = false;
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    if (index == 0) {
                                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => TeenQuiz()));
